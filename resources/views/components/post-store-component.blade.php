        ...
        <div class="relative p-4 w-full max-w-2xl max-h-full">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="flex items-center p-4 md:p-5 border-t border-gray-200 rounded-b dark:border-gray-600">
                    ...
                    <button hx-trigger="click" hx-post="/api/store/post" hx-target="#alert"
                    ...
                    <div hx-post="/api/store/post"
                        hx-trigger="keyup from:[name='keyupExample']"
                        hx-target="#alert"
                        hx-include="[name='keyupExample']"
                        hx-vals='js:{lastKey: event.key}'>

                      </div>
                      <input name="keyupExample" type="text" />
                </div>
                </form>
            </div>
        </div>
